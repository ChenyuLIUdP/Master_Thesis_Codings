# mémoire m2 script 2: extractions des données à tester : /ai/
...
for iSon from 1 to nSon
    ...
    fichierSon$ = chemin$ + diphtongue$ + ton$ + "/" + fichierSonNom$
   	...
   	for iIntervalle from 1 to nIntervalles
      	...
      	if label$ = "Ay" or label$ = "Áy" or label$ = "Ây" or label$ = "Ày"
            ...
            selectObject: son
            if sexe$ = "F"
            	formants1 = To Formant (burg): 0, 5, 5500, 0.025, 30
            elsif sexe$ = "M"
            	formants1 = To Formant (burg): 0, 5, 5000, 0.025, 30
            endif
